...
const shardCount = 2; // Ganti dengan jumlah shard yang Anda inginkan
const shardID = 0; // Ganti dengan ID shard ini (mulai dari 0 hingga shardCount - 1)
...
if (clientID && clientSecret) {
    // Shard-specific Lavalink client
...
client.on(Discord.ShardEvents.Error, error => {
    console.log(error)
    const embed = aDiscord.EmbedBuilder()
