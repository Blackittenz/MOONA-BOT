...
module.exports = async (client, message) => {
  ...
  if (
    ...
    client
      .embed(
        {
          title: "Hi, i'm Moona Hoshinova!",
          desc: `Use with commands via Discord ${client.emotes.normal.slash} commands or </help:1050230306663321649>`,
          fields: [
            {
              name: "📨┆Invite me",
              value: `Invite Moona to your own server! [Click here](${client.config.discord.botInvite})`,
            },
            {
